...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/npm-registry` | `npm install @voxgig-sdk/npm-registry` |
| Python | `voxgig-sdk-npm-registry` | `pip install voxgig-sdk-npm-registry` |
| PHP | `voxgig-sdk/npm-registry` | `composer require voxgig-sdk/npm-registry` |
| Golang | `github.com/voxgig-sdk/npm-registry-sdk/go` | `go get github.com/voxgig-sdk/npm-registry-sdk/go` |
| Ruby | `voxgig-sdk-npm-registry` | `gem install voxgig-sdk-npm-registry` |
| Lua | `voxgig-sdk-npm-registry` | `luarocks install voxgig-sdk-npm-registry` |
