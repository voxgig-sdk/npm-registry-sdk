...
describe('exists', async () => {
  ...
  //
  // NpmRegistrySDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof NpmRegistrySDK, true,
      'NpmRegistrySDK.test() must return a client synchronously')
  })
