...
#      offline in seeded test mode (NpmRegistrySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NpmRegistry_sdk.rb")
  SDK_CLASS = "NpmRegistrySDK"
