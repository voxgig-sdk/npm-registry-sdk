...
const testSeed = `map[string]any{"entity": map[string]any{"get_package": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
