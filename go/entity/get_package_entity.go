...
import (
	...
	vs "github.com/voxgig-sdk/npm-registry-sdk/go/utility/struct"
)

type GetPackageEntity struct {
	name    string
	client  *core.NpmRegistrySDK
...
func NewGetPackageEntity(client *core.NpmRegistrySDK, entopts map[string]any) *GetPackageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetPackageEntity) GetName() string { return e.name }
...
func (e *GetPackageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetPackageEntity) Deleted() bool {
	return e.deleted
}


func (e *GetPackageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetPackageEntity(e.client, opts)
}

func (e *GetPackageEntity) Data(args ...any) any {
...
func (e *GetPackageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetPackage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetPackageEntity) DataTyped(data ...GetPackage) GetPackage {
	if len(data) > 0 {
		return typedFrom[GetPackage](e.Data(asMap(data[0])))
	}
	return typedFrom[GetPackage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetPackage (all fields
// optional at the wire level).
func (e *GetPackageEntity) MatchTyped(match ...GetPackage) GetPackage {
	if len(match) > 0 {
		return typedFrom[GetPackage](e.Match(asMap(match[0])))
	}
	return typedFrom[GetPackage](e.Match())
}
...
func (e *GetPackageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetPackageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetPackageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetPackageListMatch and returns []GetPackage. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetPackageEntity) ListTyped(reqmatch GetPackageListMatch, ctrl map[string]any) ([]GetPackage, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetPackage](res), nil
}



func (e *GetPackageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetPackageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetPackageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetPackageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
