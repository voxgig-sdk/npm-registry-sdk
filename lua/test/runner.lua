...
function runner.env_override(m)
  local live = runner.getenv("NPMREGISTRY_TEST_LIVE")
  local override = runner.getenv("NPMREGISTRY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NPMREGISTRY_TEST_EXPLAIN")
