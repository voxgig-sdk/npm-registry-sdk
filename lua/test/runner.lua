...
function runner.env_override(m)
  local live = runner.getenv("NPM_REGISTRY_TEST_LIVE")
  local override = runner.getenv("NPM_REGISTRY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NPM_REGISTRY_TEST_EXPLAIN")
