...
local GetPackageEntity = {}
GetPackageEntity.__index = GetPackageEntity


function GetPackageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetPackageEntity)
  self._name = "get_package"
  self._client = client
...
function GetPackageEntity:get_name()
  return self._name
end


function GetPackageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetPackageEntity.new(self._client, opts)
end
...
function GetPackageEntity:mark_deleted()
  self._deleted = true
end


function GetPackageEntity:deleted()
  return true == self._deleted
end


function GetPackageEntity:data_set(args)
  if args ~= nil then
...
function GetPackageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetPackageEntity:match_set(args)
  if args ~= nil then
...
function GetPackageEntity:match_get()
...
function GetPackageEntity:stream(action, args, callopts)
...
---@param reqmatch GetPackageListMatch
---@param ctrl? table
---@return GetPackage[]
---@return string? err
function GetPackageEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GetPackageEntity:_run_op(ctx, post_done)
  local utility = self._utility
