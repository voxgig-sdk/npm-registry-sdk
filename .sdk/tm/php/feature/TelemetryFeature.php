...
// NpmRegistry SDK telemetry feature
...
class NpmRegistryTelemetryFeature extends NpmRegistryBaseFeature
{
    ...
    private function _close(NpmRegistryContext $ctx, bool $ok): void
    {
