...
class NpmRegistryProxyFeature extends NpmRegistryBaseFeature
{
    ...
    public function init(NpmRegistryContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NpmRegistryContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
