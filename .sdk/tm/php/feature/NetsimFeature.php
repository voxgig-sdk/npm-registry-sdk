...
// NpmRegistry SDK netsim feature
...
class NpmRegistryNetsimFeature extends NpmRegistryBaseFeature
{
    ...
    private function _simulate(NpmRegistryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NpmRegistryContext $ctx, array $applied): void
    {
        $client = $this->client;
