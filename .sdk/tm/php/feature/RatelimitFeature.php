...
// NpmRegistry SDK ratelimit feature
...
class NpmRegistryRatelimitFeature extends NpmRegistryBaseFeature
{
    ...
    private function _acquire(NpmRegistryContext $ctx): void
    {
    ...
    private function _track(NpmRegistryContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
