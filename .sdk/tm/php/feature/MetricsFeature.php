...
// NpmRegistry SDK metrics feature
...
class NpmRegistryMetricsFeature extends NpmRegistryBaseFeature
{
    ...
    private function _record(NpmRegistryContext $ctx, bool $ok): void
    {
