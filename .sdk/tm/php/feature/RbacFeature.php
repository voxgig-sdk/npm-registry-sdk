...
class NpmRegistryRbacFeature extends NpmRegistryBaseFeature
{
    ...
    private function _required(NpmRegistryContext $ctx): ?string
    {
    ...
    private function _reject(NpmRegistryContext $ctx, string $required): void
    {
    ...
    private function _track(NpmRegistryContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
