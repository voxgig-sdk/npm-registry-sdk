...
{
    private static function utility(): NpmRegistryUtility
    {
        return new NpmRegistryUtility();
    }
    ...
    private static function ctx(array $over = []): NpmRegistryContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NpmRegistryContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NpmRegistryOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NpmRegistryError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NpmRegistryOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NpmRegistryMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NpmRegistryOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NpmRegistryMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NpmRegistryOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NpmRegistryMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NpmRegistrySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NpmRegistryMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NpmRegistryResponse([]),
            'result' => new NpmRegistryResult([]),
        ]);
        [, $err] = NpmRegistryMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NpmRegistrySpec([]),
            'response' => null,
            'result' => new NpmRegistryResult([]),
        ]);
        [, $err] = NpmRegistryMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NpmRegistrySpec(['step' => 's']),
            'response' => new NpmRegistryResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NpmRegistryResult([]),
        ]);
        [, $err] = NpmRegistryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NpmRegistrySpec(['step' => 's']),
            'response' => new NpmRegistryResponse(self::resp(200, ['v' => 1])),
            'result' => new NpmRegistryResult([]),
        ]);
        [, $err] = NpmRegistryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NpmRegistrySpec(['step' => 's']),
            'response' => new NpmRegistryResponse(self::resp(200, ['v' => 2])),
            'result' => new NpmRegistryResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NpmRegistryMakeResponse::call($ctx);
    ...
    {
        $preset = new NpmRegistryResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NpmRegistrySpec([]),
            'response' => new NpmRegistryResponse([]),
            'result' => new NpmRegistryResult([]),
        ...
        [$got, $err] = NpmRegistryMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NpmRegistryResult([])]);
        [, $err] = NpmRegistryMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NpmRegistrySpec([]), 'result' => null]);
        [, $err] = NpmRegistryMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NpmRegistrySpec(['step' => 's']),
            'result' => new NpmRegistryResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NpmRegistryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NpmRegistryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NpmRegistrySpec(['step' => 's']),
            'result' => new NpmRegistryResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NpmRegistryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NpmRegistryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NpmRegistryResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NpmRegistrySpec([]),
            'result' => new NpmRegistryResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NpmRegistryMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NpmRegistryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NpmRegistryError('boom', 'boom');
        $utility->fetcher = function (NpmRegistryContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NpmRegistrySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NpmRegistryMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NpmRegistryContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NpmRegistryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NpmRegistryResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NpmRegistryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NpmRegistryContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NpmRegistrySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NpmRegistryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NpmRegistryResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NpmRegistrySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NpmRegistryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NpmRegistryMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NpmRegistryMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NpmRegistryResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NpmRegistryDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NpmRegistryResult(['ok' => false])]);
        $this->expectException(NpmRegistryError::class);
        NpmRegistryDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NpmRegistryResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NpmRegistryMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NpmRegistryMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NpmRegistryBaseFeature();
        $b = new NpmRegistryBaseFeature();
        NpmRegistryFeatureAdd::call($ctx, $a);
        NpmRegistryFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NpmRegistryBaseFeature
    {
        $f = new NpmRegistryBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NpmRegistryFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NpmRegistryContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NpmRegistrySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NpmRegistryPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NpmRegistryPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NpmRegistryResponse(['headers' => null]),
            'result' => new NpmRegistryResult([]),
        ]);
        NpmRegistryResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NpmRegistryResultBody::call($ctx);
