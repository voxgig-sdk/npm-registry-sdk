...
// NpmRegistry SDK utility: graphql
//
...
class NpmRegistryGraphql
{
    ...
    // equivalent.
    public static function body(NpmRegistryContext $ctx): mixed
    {
    ...
    public static function errors(NpmRegistryContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
