...
class NpmRegistryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NpmRegistryTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NpmRegistryTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NpmRegistryTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
