...
class NpmRegistryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NpmRegistryTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NpmRegistryTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NpmRegistryTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
