...
// NpmRegistry SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NpmRegistrySDK::test)
...
{
    private const SDK_CLASS = 'NpmRegistrySDK';
    ...
    private const SDK_BASE = 'npmregistry_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../npmregistry_sdk.php';
