...
// NpmRegistry SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NpmRegistryTestFeature extends NpmRegistryBaseFeature
{
    ...
    public function init(NpmRegistryContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NpmRegistryContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NpmRegistryParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NpmRegistryContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NpmRegistryContext $ctx, $op, $args): array
    {
