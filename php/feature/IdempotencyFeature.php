...
// NpmRegistry SDK idempotency feature
...
class NpmRegistryIdempotencyFeature extends NpmRegistryBaseFeature
{
    ...
    private function _mutating(NpmRegistryContext $ctx): bool
    {
