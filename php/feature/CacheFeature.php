...
class NpmRegistryCacheFeature extends NpmRegistryBaseFeature
{
    ...
    private function _through(NpmRegistryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
