...
// NpmRegistry SDK timeout feature
...
class NpmRegistryTimeoutFeature extends NpmRegistryBaseFeature
{
    ...
    private function _with_timeout(NpmRegistryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NpmRegistryContext $_ctx, float $ms): void
    {
        $client = $this->client;
