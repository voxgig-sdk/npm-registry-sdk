...
// NpmRegistry SDK clienttrack feature
...
class NpmRegistryClienttrackFeature extends NpmRegistryBaseFeature
{
    ...
    public function PostConstruct(NpmRegistryContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NpmRegistry-SDK';
