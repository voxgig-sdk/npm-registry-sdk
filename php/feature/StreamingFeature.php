...
// NpmRegistry SDK streaming feature
...
class NpmRegistryStreamingFeature extends NpmRegistryBaseFeature
{
    ...
    private function _iterate(NpmRegistryResult $result): \Generator
    {
    ...
    private function _streamable(NpmRegistryContext $ctx): bool
    {
