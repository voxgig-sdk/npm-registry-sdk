...
// NpmRegistry SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NpmRegistryMakeRequest
{
    public static function call(NpmRegistryContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NpmRegistryResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NpmRegistryResponse($fetched);
        } else {
