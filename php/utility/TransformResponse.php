...
// NpmRegistry SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NpmRegistryTransformResponse
{
    public static function call(NpmRegistryContext $ctx): mixed
    {
        ...
        $transform = NpmRegistryHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
