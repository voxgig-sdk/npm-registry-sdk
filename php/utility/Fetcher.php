...
// NpmRegistry SDK utility: fetcher
...
class NpmRegistryFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NpmRegistrySDK/1.0)';
    ...
    public static function call(NpmRegistryContext $ctx, string $fullurl, array $fetchdef): array
    {
