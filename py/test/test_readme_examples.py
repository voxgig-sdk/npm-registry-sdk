# NpmRegistry SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NpmRegistrySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NpmRegistrySDK(...) and NpmRegistrySDK.test(...) become
#      NpmRegistrySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "npmregistry_sdk"
_SDK_CLASS = "NpmRegistrySDK"
