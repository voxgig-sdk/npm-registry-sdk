...
class NpmRegistryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NpmRegistryTestRunner.getenv("NPMREGISTRY_TEST_LIVE")
        override = NpmRegistryTestRunner.getenv("NPMREGISTRY_TEST_OVERRIDE")
        ...
        explain = NpmRegistryTestRunner.getenv("NPMREGISTRY_TEST_EXPLAIN")
