...
from npmregistry_sdk.utility import register

# Load features
from npmregistry_sdk.feature.base_feature import NpmRegistryBaseFeature
from npmregistry_sdk.features import _has_feature, _make_feature
...
class NpmRegistrySDK:
    ...
    def get_utility(self):
        return NpmRegistryUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NpmRegistrySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetPackage(self, data=None) -> "GetPackageEntity":
        ...
        from npmregistry_sdk.entity.get_package_entity import GetPackageEntity
        return GetPackageEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from npmregistry_sdk.entity.search_entity import SearchEntity
