...
from npmregistry_sdk.core.helpers import get_ctx_prop, to_map
...
class NpmRegistryContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NpmRegistrySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NpmRegistryResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NpmRegistryResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NpmRegistryError(code, msg, self)
