...
AQL-driven CLI and REPL for the NpmRegistry SDK. Positional arguments are
...
./npm-registry-cli load 1 get_package
./npm-registry-cli load '{id:1}' get_package
