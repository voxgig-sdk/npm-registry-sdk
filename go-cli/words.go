...
func registerSDKWords(r *eng.Registry, client *sdk.NpmRegistrySDK) {
...
func runOp(client *sdk.NpmRegistrySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
