// Command NpmRegistry-mcp is an MCP server exposing the NpmRegistry
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NpmRegistry_list  — list records of an entity
//	NpmRegistry_load  — load a single record of an entity
//
